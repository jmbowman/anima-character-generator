$advantages = {
  ...
  'Aptitude in a Field': {Cost: 2, Options: Object.keys($ability_fields), Option_Title: 'Select a field'},
  ...
  'Danger Sense': {Cost: 2},
  Disquieting: {Cost: 1},
  'Dual Limit': {Category: 'Psychic', Cost: 1}, // choose up to 2 limits 
  Elan: {Cost: [1,2,3], Options: [], Option_Title: 'Enter the name of the Beryl or Shajad'},
  'Element Compatibility': {Category: 'Magic', Cost: 1}, //+ 20 MA and +20 MR in one element -20 in opposing. if necro then all.
  ...
  'Imperceptible Ki': {Category: 'Psychic', Cost: 1}, // +10 to ki concealment per level.  does not grant any benefit without ability ki concealment
  'Improved Innate Spell': {Category: 'Magic', Cost: [1,2,3]},
  'Increased Ki Accumulation': {Category: 'Psychic', Cost: [1,2]},
  'Increased Natural Bonus': {Cost: 2},  // twice the  usual bonus to a secondary when levelling
  'Increased Psychic Modifier': {Category: 'Psychic', Cost: 1},  
  ...
  'Innate Power': {Category: 'Psychic', Cost: 1},
  'Jack of All Trades': {Cost: 2},
  'Ki Perception': {Category: 'Psychic', Cost: 1},  // +10 per level to key detection
  ...
  'Martial Learning': {Category: 'Psychic', Cost: 1},  // increases learning level by 2
  'Martial Mastery': {Cost: [1,2,3]},
  'Masterful Seals': {Category: 'Psychic', Cost: 1}, // +2 levels for difficulty of setting a seal
  ...
  'Night Vision': {Cost: 1},
  'No Gestures': {Category: 'Psychic', Cost: 1},  // no reduction to ki accumulation
  ...
  'Psychic Inclination':  {Category: 'Psychic', Cost: 2}, // +1 level of greater difficulty for one of his psychic disciplines.
  ...
  'Total Accumulation': {Category: 'Psychic', Cost: 2},
  ...
  'Unconnected Techniques': {Category: 'Psychic', Cost: 1},
...
$disadvantages = {
  ...
  Feeble: {Cost: 1},  // -30 all action penalty when below 1/3 of total LP
